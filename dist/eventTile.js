...
const updateTileTime = (timeText, eventData) => {
    timeText.innerText = `${getDisplayableTime(parseInt(eventData.startTime.hour, 10), parseInt(eventData.startTime.minutes, 10))} - ${getDisplayableTime(parseInt(eventData.endTime.hour, 10), parseInt(eventData.endTime.minutes, 10))}`;
};
