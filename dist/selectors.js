...
const getModalInputs = () => {
    ...
    const [dateInput, startTime, endTime] = Object.entries(modalInputsIds).map(([key, inputId]) => getModalInputById(inputId));
...
export { getModal, getSaveBtn, getCloseBtn, getSettingsToggleElements, getModalInputs, getGrid, getGridDays, getModalInputById, };
